...
const skillBubbles = [
  ...
  { name: "GitHub Actions",   size: "md",  color: "amber" },
  { name: "Azure",            size: "md",  color: "amber" },
  { name: "CI/CD",            size: "md",  color: "amber" },
  { name: "React",            size: "md",  color: "amber" },
  { name: "PostgreSQL",       size: "md",  color: "amber" },
  { name: "C#",               size: "md",  color: "amber" },
  { name: "FastAPI",          size: "md",  color: "amber" },
  { name: "Redis",            size: "sm",  color: "amber" },
  { name: "CNN",              size: "md",  color: "amber" },
  { name: "ResNet",           size: "sm",  color: "amber" },
  { name: "Transfer Learning",size: "md",  color: "amber" },
  { name: "Scikit-learn",     size: "sm",  color: "amber" },
  { name: "NumPy",            size: "sm",  color: "amber" },
  { name: "Pandas",           size: "sm",  color: "amber" },
  { name: "Power BI",         size: "sm",  color: "amber" },
  { name: "TypeScript",       size: "md",  color: "amber" },
  { name: "React Native",     size: "sm",  color: "amber" },
  { name: "SQL",              size: "sm",  color: "amber" },
  { name: "Hadoop",           size: "sm",  color: "amber" },
  { name: "Clean Architecture",size:"md",  color: "amber" },
  { name: "ETL",              size: "sm",  color: "amber" },
  { name: "Active Directory", size: "sm",  color: "amber" },
  { name: "TCP/IP",           size: "sm",  color: "amber" },
  { name: "Feature Engineering",size:"sm", color: "amber" },
  { name: "Windows Server",   size: "sm",  color: "amber" },
  { name: "EDA",              size: "sm",  color: "amber" },
];
